...
- **CF Archive** → nothing yet — that wing imports later (the 5,800-video channel); button arrives with the wing. **Saba's ruling 2026-07-20 (two beats): the CF Archive's curator gets their press AND their voice. THE CURATOR IS NAMED: PAUL CANADA** (Saba, via Facebook) — a known brother already in the book: watched their services (named from the pulpit 2017-06-04), corresponded with Saba (2018), present at the Zoom waitings (2021-07-03 "Brother Paul Canada, are you there tonight?"). Alive; never met Saba in person as of 2018. The invitation addresses Brother Paul by name. (1) Named and honored when the wing comes in: credit on the wing itself (its button/door and its services' source lines), candidate spot on the memorial/VIP roll. (2) **"He should be contacted and offered a voice into edit information"** — contact via the channel's linked Facebook page, and offer him a curator's seat in the ruling layer for his own wing: the suggestion door (Archive_Suggestions.db — hearing/naming/meaning corrections) opened to him for the CF Archive services. He kept these tapes; he knows the voices — his corrections outrank the machine, per the ruling-layer law (teacher outranks machine). Saba approves his rulings like any others (the reviewer's word stays the keeper's). **The invitation carries a showing (Saba 2026-07-20: send him what we are inviting him to):** coming work prepares an invitation PACKAGE, not a bare letter — (a) a small first taste of his channel imported by the proven road (Helm's Waiting on God sessions first, per Saba's priorities), his credit already on every source line; (b) a receipt/portion made from his own tapes — a question asked, his tape answering, timestamped — so he SEES what his work becomes; (c) the letter for Saba's hand: who we are, the honor, the seat offered (his voice into the information), and the showing enclosed. Saba reviews all three before anything is sent; the sending is Saba's act, via the Facebook account he knows. Nothing goes out without his word.
