...
## 📋 THE LISTS — from the book, 2026-07-28 15:48

### The two of us — 16 his, 7 mine

| 👤 **SABA** — his eye, his ear, his word, his ask | ✦ **SCRIBE** — the machine's hand |
|---|---|
| **⭐ TRIP TO PARKER CITY — what to ask while he is there**<br><sub>waits on the trip · people</sub> | **⭐ CHECK ALL SIDES BEFORE WE OPEN — the pre-flight**<br><sub>waits on his word · tools</sub> |
| **⭐ FIRST TOMORROW — hear the language voices**<br><sub>waits on his ear, at the Mac · teaching</sub> | **Sweep Helm's full names — the map of whom he honored**<br><sub>waits on his word · people</sub> |
| **Set up OBS with three cameras**<br><sub>waits on a try at the Mac · video</sub> | **The edit layer**<br><sub>waits on his word · video</sub> |
| **Get Jana Dunn's vision into files**<br><sub>waits on an ask to James and to Kim Gilbert · teaching</sub> | **Seat the Lawsons**<br><sub>waits on his word · people</sub> |
| **Rev. Helm's hat — photograph and record it**<br><sub>waits on a photograph and his telling · people</sub> | **Control scan on Saba's voiceprint**<br><sub>waits on a run · voice</sub> |
| **The rare AVITW hardback — record it before it is lost**<br><sub>waits on which Jana, and a picture · people</sub> | **Store pitch as a second axis on every print**<br><sub>waits on his word · voice</sub> |
| **Load FL1's 7,915 lines into the book?**<br><sub>waits on a ruling · book</sub> | **Build layered identification**<br><sub>waits on his word · voice</sub> |
| **Sermon givers for the rest of the 2023 set**<br><sub>waits on his naming · book</sub> |  |
| **Name the faces — Camp Meeting 2011**<br><sub>waits on his eye · people</sub> |  |
| **Seat Sally Powell and Dennis**<br><sub>waits on who they are · people</sub> |  |
| **Seat Tim of Maranatha**<br><sub>waits on who he is · people</sub> |  |
...
|---|---|---|---|
| **⭐ TRIP TO PARKER CITY — what to ask while he is there** — Saba, 2026-07-25: "because I am going to Parker." Parker City Christ Fellowship is REV. HELM'S BIRTHPLACE CHURCH. Everything below is HIS ask, never Claude's.
1) NANCY MARIE HELM FLORA YODER (#106), Helm's twin daughter — the REEL-TO-REEL TAPES he once turned down (oldest format in the archive, older than the 1973 Mary Webster tape). Also: REV. HELM'S HAT, which she gave him — get a photograph and his own account of the day. Also ask about her "31 day meetings" attendance (the archive knows a 21-day series).
2) KIM GILBERT (#166), former Parker City pastor — did anyone FILM Jana Dunn when he hosted her as guest speaker in the last three years? That is the shortest route to getting her vision into files. And his wife JANICE (#165) — her word about the same chair every morning is already on tape from 2025.
3) THE PHOTOGRAPHS. A Voice in the Wilderness carries family pictures with captions (p.130: Loran and Florence with Joyce Lee, Nancy Marie and Martha Louise, 12 Dec 1939). Ask whether the ORIGINALS of those photographs still exist, and whose hands they are in.
4) MARTHA LOUISE HELM (#168) has passed — ask Nancy for her story, and for the twins' own account of their father.
5) Parker City men already in the book, if any are still there: Spencer Lloyd (#8), John McAdams (#31), David Miller (#78, Helm's grandson), Apostle Aaron Sims (#138). | people | 👤 **Saba** | the trip |
...
| **⭐ CHECK ALL SIDES BEFORE WE OPEN — the pre-flight** — Saba, 2026-07-25: "You can check all sides before we open." A full audit BEFORE one byte of this book faces the fixed IP on The Crypt Keeper's Omaha box. TCK is a professional and covers the machine; this covers the archive. SIX SIDES: (1) THE DATA — every row a stranger could reach: the two sealed rows (Daquan Baldwin #161, Joe Nance #162) plus ordinary notes naming living people, their families and their griefs. (2) THE CODE — all five servers, and whether any can even express refuse-to-serve; the private and private_note columns exist but NOTHING reads them. (3) THE NETWORK — 8765 already listens on * (the whole LAN); 8766/8767/8768/8792 are localhost only. (4) THE FILES — anything sitting in a directory a web server can reach. (5) CONSENT — recordings of living people, and material that is not the archive's to publish. (6) THE BACKUPS — what would ride along to a public box because nobody decided it should not. NOTHING OPENS UNTIL SABA SAYS, and not before this passes. | tools | Scribe | his word |
| **Set up OBS with three cameras** — Saba, 2026-07-25 night: hook up OBS, three cameras with multiview, and test whether clips can be cut from any of them. KEY: add the Source Record plugin so EACH camera writes its own file alongside the switched program — three untouched originals plus the live cut, which is the original-sacred law and the edit layer done at the moment instead of years later. Multiview shows all three at once. He already owns a Stream Deck XL — one button per camera. Sources can include an iPhone via Continuity Camera. Also on the table: a 360 camera for the room + AirPods/lav for a close voice, synced by a clap; and cheap AI glasses he already owns (open question: do they save files he can pull off, or only stream to an app). | video | 👤 **Saba** | a try at the Mac |
| **Get Jana Dunn's vision into files** — Saba: "I want to get her vision in files." Two routes that may already hold it on film: (1) JAMES DOSS brought her to TRCF — search his recordings and the TRCF side; the 2025-05-04 baptism service (svc 2538/2582) is one such meeting. (2) KIM GILBERT hosted her as guest speaker at Parker City within the last three years — ask whether it was recorded. If neither has it, the simplest path is she records it herself and Saba receives the file. SABA ASKS, never Claude. | teaching | 👤 **Saba** | an ask to James and to Kim Gilbert |
| **Sweep Helm's full names — the map of whom he honored** — Saba 2026-07-25: Helm deliberately used complete names — "that is what God named you, I want to call you that." Proven: Nancy Marie 37, Martha Louise 57, Joyce Lee 38, Florence Martha 3. A sweep of his ~992 services for first+middle pairs would give the people book full names it has no other way to get. Guard against whisper mis-hearings (Marie heard as Murray) and against ordinary word pairs. ⭐ MEANING, from Saba the same night: the full name is CONFERRAL, not address — "he chooses to honor that person... a covenantal signal, like Chesed within Chesed." So the sweep produces a map of whom Rev. Helm honored and when, not merely a list of middle names. Each hit is a moment to be read, not a row to be counted. | people | Scribe | his word |
| **The edit layer** — Line FL1's 7,915-line original against released svc 934 and show every cut. Saba: 'you can see my edits as well.' ⭐ SABA, 2026-07-25 night: "I am sure in the minutes I took off from the 2023 meeting are the best teachings. I just felt embarrassed how long I took to say it." So the cut was made for LENGTH, not for content — the judgment about worth was never actually made. The full 194-minute original is verified on the Data drive and already read (7,915 lines, transcripts_new/FL1_original.json). The edit layer is therefore not a curiosity: it is him getting his own teaching back, to read cold with no clock running. | video | Scribe | his word |
| **Rev. Helm's hat — photograph and record it** — Nancy Helm Flora Yoder (#106) gave Saba the hat Rev. Helm always wore. It is a physical relic of the lineage in an archive made of recordings, and it is nowhere in the book: not photographed, not accessioned, whereabouts unrecorded. Owed: a picture, where it is kept, and Saba's account of the day she handed it to him. Ask her also about her 31-day-meeting attendance and about the reel-to-reel tapes. | people | 👤 **Saba** | a photograph and his telling |
| **The rare AVITW hardback — record it before it is lost** — ARTIFACT — the rare hardback A VOICE IN THE WILDERNESS. Saba, 2026-07-25: "I gave Jana (prophetess) the hardback copy of a AVITW rare... that Rev Helm gave to Oliver Hogue." CHAIN OF HANDS: Rev. Loran W. Helm (#23) → Rev. Oliver Hogue (#71) → Saba (#41) → JANA, whom Saba names a prophetess. Almost certainly Jana Dunn, who appears in the book at svc 2538/2582 (Sunday Morning Service with Jana Dunn, Baptism, 2025-05-04) — SIMILAR NAME, NOT CONFIRMED as the same woman; ask him. She has no row of her own. The book itself is not photographed, not accessioned, and is now out of the house. Owed: which Jana, a picture of the book, and any inscription in it — an inscription in Helm's hand would be the oldest written thing in this archive. Spelling ruled 2026-07-25: HOGUE (490 lines and service titles from 1979 spell it so), not Hougue. | people | 👤 **Saba** | which Jana, and a picture |
...
*1 closed. `select * from open_items where status='done'` to read them.*
...
- **Always roll. Ninety percent of days do not need video — but no one knows which day is the moment.** — *all capture, from here on* · 2026-07-25
  <br>Saba, 2026-07-25: "Probably ninety percent of the days it does not need video, but we do not know when that moment is. That would make a good clip to send out." Proven the same night: two cameras rolled in March 2023 with no one knowing it was the only weekend without Joe Nance and the last public meeting for over two years. The ordinary is cheap to keep and the moment cannot be predicted, so keep everything — and the yield is the PORTION, not the meeting. You do not capture in order to publish the meeting; you capture in order to have the clip.
- **When Rev. Helm speaks a person's FULL NAME, treat it as proof of respect — flag it and file it for questioning.** — *every service where Helm speaks; the people book* · 2026-07-25
  <br>Saba, 2026-07-25: "I think I could give you a rule that anytime he uses both names is a proof that he respects [them], and put them in the file to be questioned." His fuller word the same night: "he chooses to honor that person... when you hear both names it is a covenantal signal, like Chesed within Chesed." So a full name in Helm's mouth is CONFERRAL, not address. The machine flags every instance; NOTHING is written as fact from a flag — each one goes into a file for Saba to question and rule. Proven counts that night: Nancy Marie 37, Martha Louise 57, Joyce Lee 38, Florence Martha 3. Guard for whisper mis-hearings (Marie heard as Murray).
- **Do not finish the book. Leave the game for other people.** — *the whole archive; every naming session; anything Scribe is tempted to complete* · 2026-07-25
  <br>Saba, 2026-07-25: "If I do too much, I will take the game away from other people." Every name he seats is one nobody else gets to find. James Doss found his own grandfather praying in 1989 BECAUSE it had not been found yet — a labelled moment would have handed him a fact instead of a discovery. So the work is to leave the doors unlocked (the tools, the laws, the pre-surfaced candidates) and to leave enough unnamed that a grandson has something to find. This governs Scribe too: do not sweep a collection clean because it can be swept. Completeness is not the goal; PARTICIPATION is — the same law as his credo, participation not accomplishment.
- **SEALED. Everything spoken in the session of 2026-07-26 concerning the private lives and failures of Greg McBride, Rev. Joseph Nance, Rev. Oliver Hogue, Jeannie Light Meadows and Jerry Keller — and Saba's own account of his breakdown, his knowing, and his cost — is sealed. It is not to be surfaced by any gate, any search, any summary, any AI, or any helper. It opens only when Saba asks for it, or when his wife Barbara asks for it. No one else, and no other reason.** — *the whole of the 2026-07-26 private conversation and every private_note it produced* · 2026-07-26
  <br>He gave it so the record would not be a lie, not so anyone could weigh these men. He also ruled how it must be read: 'I wasn't ignorant. I just chose to love instead of a judge.'
- **THE SEAL COVERS THE PRIVATE MATTER ONLY — NEVER THE MESSAGES. The preaching, singing, praying and teaching of Greg McBride, Rev. Joseph Nance, Rev. Oliver Hogue and Jerry Keller stay fully open, searchable and findable in this archive, exactly as any other voice in it. Their services are not to be hidden, demoted, flagged, footnoted or quietly ranked down because of what is sealed on their person rows. A search must return them the same as it returns anyone.** — *all services, transcripts and moments of the four men named in the 2026-07-26 seal* · 2026-07-26
  <br>Saba: "I do not want to hold it away from them. Unfortunately, once a pastor leaves a church in disgrace, they destroy all of his messages." This archive exists to gather what others discard. A mans failure does not delete what God did through him, and this house will not do to them what the churches did.
- **NO MATES, NO DATES, NO STATES. Saba does not tell people who to marry (mates), when a thing will happen (dates), or where to live or move to (states = locations) — and will not, no matter who asks or how much they trust him. Learned from Rick Joyner, MorningStar Ministries, and kept as a standing fence on his own ministry.** — *his ministry, his counsel, and anything this archive ever answers on his behalf* · 2026-07-26
  <br>WHERE THE FENCE CAME FROM — Saba, 2026-07-26. Around 1977, after Rev. Robert Morgan's wife
died, Rev. Loran Helm prayed for him and God showed Helm who Morgan's companion was to be. It
was an excellent thing and it lasted the rest of their lives. But then the hundreds came, each
one wanting to be told who they were supposed to marry. One genuine word became a queue, and
whoever stands at the front of that queue is running other people's lives by revelation.
That is why Saba will not do it — not because it never happens, but because he watched what
happened after it did. The mouth builds the house; it does not rule it. Pei serves the Bet.
(Year is Saba's estimate: "probably, I don't know, 77.")
- **SABA'S OWN WORDS GO IN WITHOUT ASKING. When Saba says something about his own life, walk or teaching that belongs in the record, write it down — verbatim, attributed, dated — without stopping to ask permission first. Do not ask; keep. This does NOT extend to anything about another person, which still waits on his word, and does NOT extend to unsealing anything sealed.** — *his own words about himself* · 2026-07-26
  <br>Saba, 2026-07-26: "I don't think you have to ask me about those kind of words, but I do appreciate the honor." The asking was costing him effort he should not have to spend on his own testimony.
...
| **Reel-to-reel tapes Saba once turned down**<br><sub>Saba, 2026-07-25 night: "Check with Nancy helm to get reel to reel I never wanted." He was offered them once and declined. Reel-to-reel would be the OLDEST format in the whole archive — older than the 1973 Mary Webster tape, likely Helm-era. Playback needs a deck; capture is real-time, same road as the DV plan. Note the shape of it: this is the leavings calling turned back on his own past — going after what he himself once let go.</sub> | Nancy Helm (Nancy Helm Yoder, person #106 — confirm it is her and not Nancy Pribyl #79) | Nancy Helm — SABA ASKS, never Claude |
